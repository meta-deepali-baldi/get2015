...
public class Bike extends Vehicle {
	...
	public String toString() {
		return "Bike [Make=" + getMake() + ", Model=" + getModel()
				+ ", Engine In CC=" + getEngineInCC()
				+ ", Fuel Capacity=" + getFuelCapacity() + ", Milage="
				+ getMilage() + ", Price=" + getPrice()
				+ ", Road Tax=" + getRoadTax() + ", Self Start=" + selfStart
				+ ", Helmet Price=" + helmetPrice + "]";
	}
