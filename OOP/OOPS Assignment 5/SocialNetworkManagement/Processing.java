...
public class Processing {
	...
	final static String DETAILS_FILE = "./src/SocialNetworkManagement/PersonDetails.txt";
	final static String FRIEND_FILE = "./src/SocialNetworkManagement/FriendsList.txt";
