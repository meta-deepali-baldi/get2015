...
public class Opportunity  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    private java.lang.String discount_Percent_Status__c;
    ...
    public Opportunity(
           ...
           java.lang.String discount_Percent_Status__c,
        ...
        this.discount_Percent_Status__c = discount_Percent_Status__c;
        this.events = events;
    ...
    /**
     * Gets the discount_Percent_Status__c value for this Opportunity.
     * 
     * @return discount_Percent_Status__c
     */
    public java.lang.String getDiscount_Percent_Status__c() {
        return discount_Percent_Status__c;
    }


    /**
     * Sets the discount_Percent_Status__c value for this Opportunity.
     * 
     * @param discount_Percent_Status__c
     */
    public void setDiscount_Percent_Status__c(java.lang.String discount_Percent_Status__c) {
        this.discount_Percent_Status__c = discount_Percent_Status__c;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.discount_Percent_Status__c==null && other.getDiscount_Percent_Status__c()==null) || 
             (this.discount_Percent_Status__c!=null &&
              this.discount_Percent_Status__c.equals(other.getDiscount_Percent_Status__c()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getDiscount_Percent_Status__c() != null) {
            _hashCode += getDiscount_Percent_Status__c().hashCode();
        }
        if (getEvents() != null) {
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("discount_Percent_Status__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Discount_Percent_Status__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
