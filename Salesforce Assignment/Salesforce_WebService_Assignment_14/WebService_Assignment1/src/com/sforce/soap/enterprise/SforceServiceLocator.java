 ...
 */
    ...
    private java.lang.String Soap_address = "https://login.salesforce.com/services/Soap/c/35.0/0DF28000000PDCZ";
    ...
    public com.sforce.soap.enterprise.Soap getSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.sforce.soap.enterprise.Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.sforce.soap.enterprise.SoapBindingStub _stub = new com.sforce.soap.enterprise.SoapBindingStub(new java.net.URL(Soap_address), this);
                _stub.setPortName(getSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "SforceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "Soap"));
        }
