...
public class SoapBindingStub extends org.apache.axis.client.Stub implements com.sforce.soap.enterprise.Soap {
    ...
    private void addBindings3() {
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Candidate__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.Candidate__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings4() {
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Import__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.Import__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "JobPosting__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.JobPosting__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings5() {
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Position__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.Position__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Review__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.Review__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings6() {
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Validation_Field__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.Validation_Field__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
