...
public class RESTServicesConsumer {
	...
	static final String USERNAME = "deepalibaldi25@metacube.com";
	static final String PASSWORD = "deepali25PyZji8nXzBkXyiT5k9lBMcqNL";
	static final String LOGINURL = "https://login.salesforce.com";
	static final String GRANTSERVICE = "/services/oauth2/token?grant_type=password";
	static final String CLIENTID = "3MVG9ZL0ppGP5UrDnffMZmmSEmBHvUCUf8qWTfibCYbm91SycLKUCXjSxxKm5WA56hf.E7.dakgWfu03_tKzh";
	static final String CLIENTSECRET = "7841079625306124598";
	...
	public static void createStudent() {
		...
		try {
			...
			student.put("Name", "REST API New");
			student.put("Class__c", "a0B28000000WYzp");
			student.put("LastName__c", "Student");
